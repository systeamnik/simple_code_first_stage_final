...
class _Images {
  ...
  final String logofull = 'assets/images/bitmap/logo-storyberry.png';
  final String splashBackground = 'assets/images/bitmap/decore-bg.png';
  final String noImage = 'assets/images/bitmap/decore-bg.png';
}
...
class _Svg {
  ...
  final String iconFilterFull = 'assets/images/svg/filter-full.svg';
  final String iconSortAsc = 'assets/images/svg/sort-asc.svg';
  final String iconSortDesc = 'assets/images/svg/sort-desc.svg';
}
